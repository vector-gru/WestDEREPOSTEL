package com.example.westderepostel.cloudsave;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        showAllBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity( new Intent(CloudMainActivity.this , ShowActivity.class));
            }
        });
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (imageUri != null){
                    ...
                    Toast.makeText(CloudMainActivity.this, "Please Select Image", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
    ...
    private void uploadToFirebase(Uri uri){
        ...
        fileRef.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                fileRef.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        progressBar.setVisibility(View.INVISIBLE);
                        Toast.makeText(CloudMainActivity.this, "Uploaded Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                progressBar.setVisibility(View.INVISIBLE);
                Toast.makeText(CloudMainActivity.this, "Uploading Failed !!", Toast.LENGTH_SHORT).show();
            }
        });
    }
